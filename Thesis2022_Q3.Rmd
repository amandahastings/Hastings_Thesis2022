...
ggplot() +
  ...
  geom_point(
    data = subset(fort.plot_LowerMontane, Score == "sites"),
    mapping = aes(x = NMDS1, y = NMDS2, shape = burn_sev_category), size=2,
    colour = "black",
    alpha = 0.5
  ) +
  # geom_text(
  ...
  geom_text(
    data = subset(fort_LowerMontane, Score == 'species'), check_overlap = T, fontface = "bold",
    size = 3.25,
...
ggplot() +
  ...
  geom_point(
    data = subset(fort.plot_UpperMontane, Score == "sites"),
    mapping = aes(x = NMDS1, y = NMDS2, shape = burn_sev_category), size=2,
    colour = "black",
    alpha = 0.5
  ) +
  ...
  geom_text(
    data = subset(fort_UpperMontane, Score == 'species'), check_overlap = T, fontface = "bold",
    size = 3.25,
    #Pushes label away from the arrow
    mapping = aes(
      label = Label,
...
ggplot() +
  ...
  geom_point(
    data = subset(fort.plot_Subalpine, Score == "sites"),
    mapping = aes(x = NMDS1, y = NMDS2, shape = burn_sev_category), size=2,
    colour = "black",
    alpha = 0.5
  ) +
  ...
  geom_text(
    data = subset(fort_Subalpine, Score == 'species'), check_overlap = T, fontface = "bold",
    size = 3.25,
    #Pushes label away from the arrow
    mapping = aes(
      label = Label,
