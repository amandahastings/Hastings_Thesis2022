...
OverlayPredictors1 <- ThesisAll1 %>% 
  ...
  dplyr::select(PlotID, burn_sev_category, forest_type, aspect_rescaled, heat_load, canopy_cover, conifer_seed_source, bg_cover, lt_cover, wd_cover, rk_cover, total_ba, CWD)%>% 
  rowwise()%>%
...
LowerMontane.env.scoresdf <- LowerMontane.env.scoresdf%>% 
  mutate("EnvPred2" = case_when(EnvPred == "aspect_rescaled"  ~ "Aspect", 
                                ...
                                EnvPred == "total_ba" ~ "Total Basal Area", 
