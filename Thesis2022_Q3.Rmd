...
ggplot() +
  ...
  geom_text(
    data = subset(fort_LowerMontane, Score == 'species'), check_overlap = F, fontface = "bold",
    size = 3.25,
...
ggplot() +
  ...
  geom_text(
    data = subset(fort_UpperMontane, Score == 'species'), check_overlap = F, fontface = "bold",
    size = 3.25,
    #Pushes label away from the arrow
    mapping = aes(
      label = Label,
...
ggplot() +
  ...
  geom_text(
    data = subset(fort_Subalpine, Score == 'species'), check_overlap = F, fontface = "bold",
    size = 3.25,
    #Pushes label away from the arrow
    mapping = aes(
      label = Label,
