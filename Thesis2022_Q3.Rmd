...
z_NMDSdf_LowerMontane <- ThesisNMDSResponse %>% 
  ...
  column_to_rownames(var="PlotID")%>% 
   rename(
      ...
      "PICO" = z_PICO_total,
      "PIFL" = z_PIFL_total)%>% 
  dplyr::select(!c(gm_cover, fb_cover, sh_cover, POTR_total, QUGA_total, RONE_total, PIPO_total, PSME_total, ABCO_total, PICO_total, PIFL_total))
...
z_NMDSdf_Subalpine <- ThesisNMDSResponse %>% 
  ...
  column_to_rownames(var="PlotID")%>%
   rename(
      ...
      "ABLA" = z_ABLA_total,
      "PIEN" = z_PIEN_total)%>% 
  dplyr::select(!c(gm_cover, fb_cover, sh_cover, POTR_total, PSME_total, ABCO_total, PICO_total, PIFL_total, PIAR_total, ABLA_total, PIEN_total))
